...
double monte_carlo_call_price(double S0, double K, double r, double sigma, double T, int num_simulations){
...
int main(){
    ...
    double price = monte_carlo_call_price(S0,K,r,sigma, T, num_simulations);
    auto end = std::chrono::high_resolution_clock::now();
    std::chrono::duration<double> duration = end - start;
    std::cout << "Monte Carlo Estimated Call Price: " << price << std::endl;
